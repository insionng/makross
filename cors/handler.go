...
// Handler creates a makross.handler that adds appropriate CORS headers according to the specified options and the request.
func Handler(opts Options) makross.Handler {
