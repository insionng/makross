...
func TestRecovery(t *testing.T) {
	...
	res = httptest.NewRecorder()
	req, _ = http.NewRequest("GET", "/users/", nil)
	c = makross.NewContext(res, req, h, handler4, handler2)
	assert.Nil(t, c.Next())
...
func handler2(c *makross.Context) error {
	c.Write("test")
	return nil
}

func handler3(c *makross.Context) error {
	panic("xyz")
}

func handler4(c *makross.Context) error {
	panic(makross.NewHTTPError(http.StatusBadRequest, "123"))
}
